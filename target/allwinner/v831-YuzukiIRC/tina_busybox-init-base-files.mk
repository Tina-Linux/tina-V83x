############################################################################################
# 			v831-YuzukiIRC busybox-init-base-files for tina(OpenWrt) Linux
#
#	v831-YuzukiIRC busybox-init-base-files will generate shell script according to some 
...
all:
	@echo ==================================================
	@echo target/allwinner/v831-YuzukiIRC/tina_busybox-init-basefiles.mk is called to generate shell scripts
	@echo ==================================================
...
clean:
	@echo ==================================================
	@echo target/allwinner/v831-YuzukiIRC/tina_busybox-init-basefiles.mk is called to clean shell scripts
	@echo ==================================================

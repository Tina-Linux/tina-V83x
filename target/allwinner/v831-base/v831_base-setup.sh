...
function cleanapp
{
    local curDir=$(pwd)
    croot
    make package/allwinner/eyesee-mpp/custom_aw/clean $@
...
{ 
    croot;
    cd softwinner/eyesee-mpp/middleware/sun8iw19p1
}

capp_p () 
{ 
    croot;
    cd package/allwinner/eyesee-mpp/custom_aw
}
capp_s () 
{ 
    croot;
    cd softwinner/eyesee-mpp/custom_aw/apps/ts-sdv
}

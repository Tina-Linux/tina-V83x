...
define KernelPackage/vin-v4l2
  ...
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor/bt656_bt1120_test.ko
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/vin_v4l2.ko
  FILES+=$(LINUX_DIR)/drivers/media/sunxi_nna/nna_sunxi.ko
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io imx307_mipi bt656_bt1120_test vin_v4l2 nna_sunxi )
endef

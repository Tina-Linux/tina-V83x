...
ifeq ($(findstring linaro, $(CONFIG_GCC_VERSION)),linaro)
    ifeq ($(CONFIG_GCC_VERSION),"linaro-5.3-2016.05")
      PKG_REV:=5.3-2016.05
      REVISION:=2016-05
      PKG_VERSION:=5.3.1
    ...
    ifeq ($(CONFIG_GCC_VERSION),"linaro-6.4-2017.11")
      PKG_SOURCE_URL:=http://releases.linaro.org/components/toolchain/gcc-linaro/6.4-2017.11/gcc-linaro-6.4-2017.11.tar.xz
      PKG_REV:=6.4-2017.11
      REVISION:=2017-11
      PKG_VERSION:=6.4.1
      PKG_VERSION_MAJOR:=6.4
      PKG_MD5SUM:=0620b19d8f58828b64c67513fb7c3476
      PKG_COMP:=xz
    endif
    ifeq ($(CONFIG_GCC_VERSION),"linaro-7.4-2019.02")
      PKG_SOURCE_URL:=http://releases.linaro.org/components/toolchain/gcc-linaro/7.4-2019.02/
      PKG_REV:=7.4-2019.02
      REVISION:=2019-02
      PKG_VERSION:=7.4.1
      PKG_VERSION_MAJOR:=7.4
      PKG_MD5SUM:=feff2ce3c21e411bef74ce076c7a4c11
      PKG_COMP:=xz
    endif

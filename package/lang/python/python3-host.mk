...
HOST_PYTHON3_DIR:=$(STAGING_DIR)/host
...
$(info *****************AAA HOST_PYTHON3_BIN = $(HOST_PYTHON3_BIN)**************)
...
HOST_PYTHON3_VARS = \
	...
	LDFLAGS="$(HOST_LDFLAGS) -lpython$(PYTHON3_VERSION) -Wl$(comma)-rpath$(comma)$(STAGING_DIR_HOST)/lib" \
...
HOST_PYTHON3_PIP:=$(HOST_PYTHON3_DIR)/bin/pip$(PYTHON3_VERSION)

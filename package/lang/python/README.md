...
Add this after  `include $(BUILD_DIR)/package.mk`
```
include ../python3-package.mk
```
...
To use `pypi.mk`, add this **before** `include $(BUILD_DIR)/package.mk`:
```
include ../pypi.mk
```
...
The Python package will be installed in `$(STAGING_DIR_HOST)/lib/pythonX.Y/site-packages`.

...
ifneq ($(strip $(PYPI_NAME)),)
  ...
  PKG_BUILD_DIR:=$(COMPILE_DIR)/pypi/$(if $(BUILD_VARIANT),$(PKG_NAME)-$(BUILD_VARIANT)/)$(PYPI_SOURCE_NAME)$(if $(PKG_VERSION),-$(PKG_VERSION))
  HOST_BUILD_DIR:=$(COMPILE_DIR_HOST)/pypi/$(PYPI_SOURCE_NAME)$(if $(PKG_VERSION),-$(PKG_VERSION))
endif

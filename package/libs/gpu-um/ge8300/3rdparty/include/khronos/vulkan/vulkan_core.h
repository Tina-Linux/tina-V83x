...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_RAY_EXECUTABLES_IMGX = 1000068000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_LIMITS_IMGX = 1000068001,
    VK_STRUCTURE_TYPE_SCENE_CREATE_INFO_IMGX = 1000068002,
    VK_STRUCTURE_TYPE_RAY_SCENE_PIPELINE_CREATE_INFO_IMGX = 1000068003,
    VK_STRUCTURE_TYPE_PIPELINE_RAY_INTERSECTION_STATE_CREATE_INFO_IMGX = 1000068004,
    VK_STRUCTURE_TYPE_RAY_EXECUTABLE_CREATE_INFO_IMGX = 1000068005,
    VK_STRUCTURE_TYPE_SCENE_BUILD_BEGIN_INFO_IMGX = 1000068006,
    VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCUMULATION_IMAGE_BINDING_IMGX = 1000068007,
...
typedef enum VkDescriptorType {
    ...
    VK_DESCRIPTOR_TYPE_RAY_EXECUTABLE_IMGX = 1000068000,
...
typedef enum VkPipelineBindPoint {
    ...
    VK_PIPELINE_BIND_POINT_SCENE_IMGX = 1000068000,
...
typedef enum VkFormatFeatureFlagBits {
    ...
    VK_FORMAT_FEATURE_STORAGE_IMAGE_ACCUMULATE_BIT_IMGX = 0x00080000,
...
typedef enum VkImageCreateFlagBits {
    ...
    VK_IMAGE_CREATE_SPARSE_MAP_ON_RENDER_BIT_IMG = 0x0080000,
...
typedef enum VkQueueFlagBits {
    ...
    VK_QUEUE_SCENE_GENERATOR_BIT_IMGX = 0x00000010,
    VK_QUEUE_RAY_TRACING_BIT_IMGX = 0x00000020,
...
typedef enum VkPipelineStageFlagBits {
    ...
    VK_PIPELINE_STAGE_SCENE_MERGE_BIT_IMGX = 0x00040000,
    VK_PIPELINE_STAGE_RAY_SHADER_BIT_IMGX = 0x00080000,
...
typedef enum VkQueryPipelineStatisticFlagBits {
    ...
    VK_QUERY_PIPELINE_STATISTIC_RAY_SHADER_INVOCATIONS_BIT = 0x00000800,
...
typedef enum VkShaderStageFlagBits {
    ...
    VK_SHADER_STAGE_RAY_BIT_IMGX = 0x00000040,
...
typedef enum VkCommandBufferUsageFlagBits {
    ...
    VK_COMMAND_BUFFER_USAGE_SCENE_BUILD_CONTINUE_BIT_IMGX = 0x00000008,
...
typedef enum VkDebugReportObjectTypeEXT {
    ...
    VK_DEBUG_REPORT_OBJECT_TYPE_SCENE_IMGX = 1000068000,
    VK_DEBUG_REPORT_OBJECT_TYPE_RAY_EXECUTABLE_IMGX = 1000068001,
...
#define VK_IMG_sparse_map_on_render 1
#define VK_IMG_SPARSE_MAP_ON_RENDER_SPEC_VERSION 0
#define VK_IMG_SPARSE_MAP_ON_RENDER_EXTENSION_NAME "VK_IMG_sparse_map_on_render"

typedef struct VkSparseMapOnRenderStatsIMG {
    uint32_t    activeRegionCount;
    uint32_t    backedRegionCount;
} VkSparseMapOnRenderStatsIMG;

typedef struct VkSparseMapOnRenderMemoryIMG {
    VkStructureType    sType;
    const void*        pNext;
    VkDeviceSize       initialSize;
    VkDeviceSize       maximumSize;
    VkDeviceSize       growSize;
} VkSparseMapOnRenderMemoryIMG;

typedef struct VkSparseMapOnRenderAttachmentResultIMG {
    VkStructureType    sType;
    const void*        pNext;
    VkBuffer           buffer;
    VkDeviceSize       bufferOffset;
    VkImage            image;
} VkSparseMapOnRenderAttachmentResultIMG;

typedef struct VkSparseMapOnRenderEnableResultsCaptureIMG {
    VkStructureType                            sType;
    const void*                                pNext;
    uint32_t                                   attachmentCount;
    VkSparseMapOnRenderAttachmentResultIMG*    pAttachmentResults;
} VkSparseMapOnRenderEnableResultsCaptureIMG;

typedef struct VkSparseMapOnRenderImageFormatPropertiesIMG {
    VkStructureType    sType;
    const void*        pNext;
    VkBool32           allowed;
    VkExtent2D         minimumSize;
    VkExtent2D         regionSize;
} VkSparseMapOnRenderImageFormatPropertiesIMG;


typedef void (VKAPI_PTR *PFN_vkGetSparseMapOnRenderImageFormatPropertiesIMG)(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkSparseMapOnRenderImageFormatPropertiesIMG* pImageFormatProperties);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vkGetSparseMapOnRenderImageFormatPropertiesIMG(
    VkPhysicalDevice                            physicalDevice,
    VkFormat                                    format,
    VkImageType                                 type,
    VkImageTiling                               tiling,
    VkImageUsageFlags                           usage,
    VkImageCreateFlags                          flags,
    VkSparseMapOnRenderImageFormatPropertiesIMG* pImageFormatProperties);
#endif

#define VK_IMG_device_sharing 1
#define VK_IMG_DEVICE_SHARING_SPEC_VERSION 0
#define VK_IMG_DEVICE_SHARING_EXTENSION_NAME "VK_IMG_device_sharing"

typedef VkResult (VKAPI_PTR *PFN_vkImportMemoryIMG)(VkDevice device, VkDeviceMemory exportedMemory, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory);
typedef VkResult (VKAPI_PTR *PFN_vkImportImageIMG)(VkDevice device, VkImage exportedImage, const VkAllocationCallbacks* pAllocator, VkImage* pImage);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkResult VKAPI_CALL vkImportMemoryIMG(
    VkDevice                                    device,
    VkDeviceMemory                              exportedMemory,
    const VkAllocationCallbacks*                pAllocator,
    VkDeviceMemory*                             pMemory);

VKAPI_ATTR VkResult VKAPI_CALL vkImportImageIMG(
    VkDevice                                    device,
...
#define VK_IMGX_ray_tracing_gr6500 1
VK_DEFINE_NON_DISPATCHABLE_HANDLE(VkSceneIMGX)
VK_DEFINE_NON_DISPATCHABLE_HANDLE(VkRayExecutableIMGX)

#define VK_IMGX_RAY_TRACING_GR6500_SPEC_VERSION 0
#define VK_IMGX_RAY_TRACING_GR6500_EXTENSION_NAME "VK_IMGX_ray_tracing_gr6500"


typedef enum VkVisibleFaceIMGX {
    VK_VISIBLE_FACE_FRONT_IMGX = 0,
    VK_VISIBLE_FACE_BACK_IMGX = 1,
    VK_VISIBLE_FACE_BOTH_IMGX = 2,
    VK_VISIBLE_FACE_BEGIN_RANGE_IMGX = VK_VISIBLE_FACE_FRONT_IMGX,
    VK_VISIBLE_FACE_END_RANGE_IMGX = VK_VISIBLE_FACE_BOTH_IMGX,
    VK_VISIBLE_FACE_RANGE_SIZE_IMGX = (VK_VISIBLE_FACE_BOTH_IMGX - VK_VISIBLE_FACE_FRONT_IMGX + 1),
    VK_VISIBLE_FACE_MAX_ENUM_IMGX = 0x7FFFFFFF
} VkVisibleFaceIMGX;

typedef VkFlags VkSceneCreateFlagsIMGX;

typedef enum VkRayExecutableCreateFlagBitsIMGX {
    VK_RAY_EXECUTABLE_CREATE_PREFIX_DESCRIPTOR_BIT_IMGX = 0x00000001,
    VK_RAY_EXECUTABLE_CREATE_FLAG_BITS_MAX_ENUM_IMGX = 0x7FFFFFFF
} VkRayExecutableCreateFlagBitsIMGX;
typedef VkFlags VkRayExecutableCreateFlagsIMGX;
typedef VkFlags VkPipelineRayIntersectionStateCreateFlagsIMGX;

typedef struct VkWriteDescriptorSetRayExecutablesIMGX {
    VkStructureType               sType;
    const void*                   pNext;
    uint32_t                      descriptorCount;
    const VkRayExecutableIMGX*    pExecutables;
} VkWriteDescriptorSetRayExecutablesIMGX;

typedef struct VkPhysicalDeviceRayTracingLimitsIMGX {
    VkStructureType    sType;
    void*              pNext;
    uint32_t           maxSceneBindingPoints;
    uint32_t           maxRayExecutableCount;
    uint32_t           maxPrefixRayExecutableCount;
    uint32_t           maxDescriptorSetRayExecutables;
    uint32_t           maxPerStageDescriptorRayExecutables;
    uint32_t           maxRayBlocks;
    uint32_t           maxRayBlockSize;
    uint32_t           maxRayBlockEmits;
    uint32_t           maxWorkgroupRayBlockEmits;
    uint32_t           maxRayInputComponents;
    uint32_t           maxRayBounceLimit;
    uint32_t           maxSharedRayConstantsSize;
    VkBool32           timestampRaytracingAndSceneGenerator;
} VkPhysicalDeviceRayTracingLimitsIMGX;

typedef struct VkWriteDescriptorSetAccumulationImageBindingIMGX {
    VkStructureType    sType;
    const void*        pNext;
    uint32_t           descriptorCount;
    const uint32_t*    pGlobalBindings;
} VkWriteDescriptorSetAccumulationImageBindingIMGX;

typedef struct VkSceneCreateInfoIMGX {
    VkStructureType           sType;
    const void*               pNext;
    VkSceneCreateFlagsIMGX    flags;
} VkSceneCreateInfoIMGX;

typedef struct VkRayExecutableCreateInfoIMGX {
    VkStructureType                   sType;
    const void*                       pNext;
    VkRayExecutableCreateFlagsIMGX    flags;
    VkPipeline                        pipeline;
    ...
    uint32_t                          dynamicOffsetCount;
    const uint32_t*                   pDynamicOffsets;
} VkRayExecutableCreateInfoIMGX;

typedef struct VkPipelineRayIntersectionStateCreateInfoIMGX {
    VkStructureType                                  sType;
    const void*                                      pNext;
    VkPipelineRayIntersectionStateCreateFlagsIMGX    flags;
    VkBool32                                         occluder;
    uint32_t                                         rayVisibilityCount;
    const VkBool32*                                  pRayVisibility;
    VkVisibleFaceIMGX                                visibleFace;
    VkFrontFace                                      frontFace;
} VkPipelineRayIntersectionStateCreateInfoIMGX;

typedef struct VkRayScenePipelineCreateInfoIMGX {
    VkStructureType                                        sType;
    const void*                                            pNext;
    VkPipelineCreateFlags                                  flags;
    uint32_t                                               stageCount;
    ...
    const VkPipelineInputAssemblyStateCreateInfo*          pInputAssemblyState;
    const VkPipelineTessellationStateCreateInfo*           pTessellationState;
    const VkPipelineRayIntersectionStateCreateInfoIMGX*    pRayIntersectionState;
    VkPipelineLayout                                       layout;
    VkPipeline                                             basePipelineHandle;
    int32_t                                                basePipelineIndex;
} VkRayScenePipelineCreateInfoIMGX;

typedef struct VkSceneExtentIMGX {
    float    x;
    float    y;
    float    z;
    float    width;
...
typedef struct VkSceneBuildBeginInfoIMGX {
    VkStructureType      sType;
    const void*          pNext;
    VkSceneExtentIMGX    extent;
    VkSceneIMGX          scene;
} VkSceneBuildBeginInfoIMGX;


typedef VkResult (VKAPI_PTR *PFN_vkCreateSceneIMGX)(VkDevice device, const VkSceneCreateInfoIMGX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSceneIMGX* pScene);
typedef void (VKAPI_PTR *PFN_vkDestroySceneIMGX)(VkDevice device, VkSceneIMGX scene, const VkAllocationCallbacks* pAllocator);
typedef VkResult (VKAPI_PTR *PFN_vkCreateRayExecutablesIMGX)(VkDevice device, uint32_t createInfoCount, const VkRayExecutableCreateInfoIMGX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkRayExecutableIMGX* pExecutables);
typedef void (VKAPI_PTR *PFN_vkDestroyRayExecutableIMGX)(VkDevice device, VkRayExecutableIMGX executable, const VkAllocationCallbacks* pAllocator);
typedef VkResult (VKAPI_PTR *PFN_vkCreateRayScenePipelinesIMGX)(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayScenePipelineCreateInfoIMGX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines);
typedef void                    (VKAPI_PTR *PFN_vkCmdSetRaySizesIMGX)(VkCommandBuffer commandBuffer, uint32_t                raySizeCount, const uint32_t*    pRaySizes);
typedef void                    (VKAPI_PTR *PFN_vkCmdSetRayBounceLimitIMGX)(VkCommandBuffer commandBuffer, uint32_t                limit);
typedef void (VKAPI_PTR *PFN_vkCmdBindRayExecutableIMGX)(VkCommandBuffer commandBuffer, VkRayExecutableIMGX rayExecutable);
typedef void (VKAPI_PTR *PFN_vkCmdBindScenesIMGX)(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkSceneIMGX* pScenes);
typedef void (VKAPI_PTR *PFN_vkCmdBeginSceneBuildIMGX)(VkCommandBuffer commandBuffer, const VkSceneBuildBeginInfoIMGX* pBeginInfo);
typedef void (VKAPI_PTR *PFN_vkCmdEndSceneBuildIMGX)(VkCommandBuffer commandBuffer);
typedef void (VKAPI_PTR *PFN_vkCmdPushSharedRayConstantsIMGX)(VkCommandBuffer commandBuffer, uint32_t offset, uint32_t size, const void* pValues);
typedef void (VKAPI_PTR *PFN_vkCmdSceneAppendIMGX)(VkCommandBuffer commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance);
typedef void (VKAPI_PTR *PFN_vkCmdSceneAppendIndexedIMGX)(VkCommandBuffer commandBuffer, uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance);
typedef void (VKAPI_PTR *PFN_vkCmdSceneAppendIndirectIMGX)(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t appendCount, uint32_t stride);
typedef void (VKAPI_PTR *PFN_vkCmdSceneAppendIndexedIndirectIMGX)(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t appendCount, uint32_t stride);
typedef void                    (VKAPI_PTR *PFN_vkCmdMergeScenesIMGX)(VkCommandBuffer commandBuffer, VkSceneExtentIMGX                dstExtent, VkSceneIMGX             dstScene, uint32_t                srcSceneCount, const VkSceneIMGX* pSrcScenes);
typedef void (VKAPI_PTR *PFN_vkCmdBindAccumulationImagesIMGX)(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkImageView* pImageViews);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkResult VKAPI_CALL vkCreateSceneIMGX(
    VkDevice                                    device,
    const VkSceneCreateInfoIMGX*                pCreateInfo,
    const VkAllocationCallbacks*                pAllocator,
    VkSceneIMGX*                                pScene);

VKAPI_ATTR void VKAPI_CALL vkDestroySceneIMGX(
    VkDevice                                    device,
    VkSceneIMGX                                 scene,
    const VkAllocationCallbacks*                pAllocator);

VKAPI_ATTR VkResult VKAPI_CALL vkCreateRayExecutablesIMGX(
    VkDevice                                    device,
    uint32_t                                    createInfoCount,
    const VkRayExecutableCreateInfoIMGX*        pCreateInfos,
    const VkAllocationCallbacks*                pAllocator,
    VkRayExecutableIMGX*                        pExecutables);

VKAPI_ATTR void VKAPI_CALL vkDestroyRayExecutableIMGX(
    VkDevice                                    device,
    VkRayExecutableIMGX                         executable,
    const VkAllocationCallbacks*                pAllocator);

VKAPI_ATTR VkResult VKAPI_CALL vkCreateRayScenePipelinesIMGX(
    VkDevice                                    device,
    VkPipelineCache                             pipelineCache,
    uint32_t                                    createInfoCount,
    const VkRayScenePipelineCreateInfoIMGX*     pCreateInfos,
    const VkAllocationCallbacks*                pAllocator,
    VkPipeline*                                 pPipelines);

VKAPI_ATTR void                    VKAPI_CALL vkCmdSetRaySizesIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    raySizeCount,
    const uint32_t*                             pRaySizes);

VKAPI_ATTR void                    VKAPI_CALL vkCmdSetRayBounceLimitIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    limit);

VKAPI_ATTR void VKAPI_CALL vkCmdBindRayExecutableIMGX(
    VkCommandBuffer                             commandBuffer,
    VkRayExecutableIMGX                         rayExecutable);

VKAPI_ATTR void VKAPI_CALL vkCmdBindScenesIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,
    const VkSceneIMGX*                          pScenes);

VKAPI_ATTR void VKAPI_CALL vkCmdBeginSceneBuildIMGX(
    VkCommandBuffer                             commandBuffer,
    const VkSceneBuildBeginInfoIMGX*            pBeginInfo);

VKAPI_ATTR void VKAPI_CALL vkCmdEndSceneBuildIMGX(
    VkCommandBuffer                             commandBuffer);

VKAPI_ATTR void VKAPI_CALL vkCmdPushSharedRayConstantsIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    offset,
    uint32_t                                    size,
    const void*                                 pValues);

VKAPI_ATTR void VKAPI_CALL vkCmdSceneAppendIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    vertexCount,
    uint32_t                                    instanceCount,
    uint32_t                                    firstVertex,
...
VKAPI_ATTR void VKAPI_CALL vkCmdSceneAppendIndexedIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    indexCount,
    uint32_t                                    instanceCount,
    uint32_t                                    firstIndex,
...
VKAPI_ATTR void VKAPI_CALL vkCmdSceneAppendIndirectIMGX(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
...
VKAPI_ATTR void VKAPI_CALL vkCmdSceneAppendIndexedIndirectIMGX(
    VkCommandBuffer                             commandBuffer,
    VkBuffer                                    buffer,
    VkDeviceSize                                offset,
    uint32_t                                    appendCount,
...
VKAPI_ATTR void                    VKAPI_CALL vkCmdMergeScenesIMGX(
    VkCommandBuffer                             commandBuffer,
    VkSceneExtentIMGX                           dstExtent,
    VkSceneIMGX                                 dstScene,
    uint32_t                                    srcSceneCount,
    const VkSceneIMGX*                          pSrcScenes);

VKAPI_ATTR void VKAPI_CALL vkCmdBindAccumulationImagesIMGX(
    VkCommandBuffer                             commandBuffer,
    uint32_t                                    firstBinding,
    uint32_t                                    bindingCount,

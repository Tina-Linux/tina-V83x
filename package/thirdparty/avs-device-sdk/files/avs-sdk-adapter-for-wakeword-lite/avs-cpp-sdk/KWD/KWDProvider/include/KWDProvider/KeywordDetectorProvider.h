...
public:
     ...
     * @param pathToInputFolder The path to the inputs folder containing data
     * files needed by this application.
     *
     * @return An @c KeywordDetector based on CMake configurations on success or
     * @c nullptr if creation failed.
     */

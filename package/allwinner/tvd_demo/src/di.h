...
__s32 di_set_reg_base(void *base);
void *di_get_reg_base(void);
__s32 di_set_init(void);
__s32 di_reset(void);
__s32 di_start(void);
__s32 di_irq_enable(__u32 enable);
__s32 di_get_status(void);
__s32 di_irq_clear(void);
__s32 di_set_para(struct __di_para_t2 *para, void *in_flag_add,
		void *out_flag_add,  __u32 field);
void di_set_mode(struct __di_mode_t *di_mode);
__s32 di_sw_para_to_reg(__u8 type, __u8 format);
__s32 di_internal_clk_enable(void);
__s32 di_internal_clk_disable(void);

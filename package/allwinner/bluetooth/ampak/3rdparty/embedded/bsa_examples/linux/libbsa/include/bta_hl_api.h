...
#ifndef BTA_HL_NUM_SUP_FEATURE_ELEMS
#define BTA_HL_NUM_SUP_FEATURE_ELEMS     13
#endif
#ifndef BTA_HL_SUP_FEATURE_SDP_BUF_SIZE
...
typedef struct
{
    ...
    BD_ADDR                 bd_addr;            /* peer bd_addr device */
...
**                  This function is called after BTA_HlRegister is called.
**                  This function registers an HDP application and update
**                  the current SDP record.
**
** Parameters       app_id        - Application ID
**                  p_reg_param   - non-platform related parameters for the
**                                  HDP application
**                  is_register   - Register or deregister an application

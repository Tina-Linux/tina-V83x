...
enum
{
    AV_LITE_STREAMING_AVDT = 0,    /* AVDT streaming */
    AV_LITE_STREAMING_CLB          /* CLB streaming */
};
typedef UINT8 tBTA_AV_LITE_STREAMING_TYPE;
...
typedef struct
{
    ...
    tBTA_AV_LITE_STREAMING_TYPE     streaming_type; /* BSA_SPECIFIC */
}tBTA_AV_SCB_REQ;

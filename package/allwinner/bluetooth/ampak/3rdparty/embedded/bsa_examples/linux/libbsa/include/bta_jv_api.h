...
**
**  Copyright (c) 2006-2011, Broadcom Corp., All Rights Reserved.
...
/* JV ID type */
#define BTA_JV_PM_ID_1             BTA_ID_JV1   /* PM profile 1 */
#define BTA_JV_PM_ID_2             BTA_ID_JV2   /* PM profile 2 */
#define BTA_JV_PM_ID_CLEAR         0xFF         /* Special JV ID used to clear PM profile */
typedef UINT8 tBTA_JV_PM_ID;

#define BTA_JV_PM_HANDLE_CLEAR     0xFF         /* Special JV ID used to clear PM profile  */

/* JV connection state */
#define BTA_JV_CONN_OPEN           0    /* Connection opened state */
#define BTA_JV_CONN_CLOSE          1    /* Connection closed state */
#define BTA_JV_APP_OPEN            2    /* JV Application opened state */
#define BTA_JV_APP_CLOSE           3    /* JV Application closed state */
#define BTA_JV_SCO_OPEN            4    /* SCO connection opened state */
#define BTA_JV_SCO_CLOSE           5    /* SCO connection opened state */
#define BTA_JV_CONN_IDLE           6    /* Connection idle state */
#define BTA_JV_CONN_BUSY           7    /* Connection busy state */
#define BTA_JV_MAX_CONN_STATE      8    /* Max number of connection state */
...
#define BTA_JV_RFCOMM_OPEN_EVT      25 /* open status of RFCOMM connection */
...
#define BTA_JV_SET_PM_PROFILE_EVT   33 /* result for bta_jv_set_pm_profile */
#define BTA_JV_NOTIFY_PM_STATE_CHANGE_EVT 34 /* result for bta_jv_notify_pm_state_change */
#define BTA_JV_API_SET_PM_EVT       35 /* the result for BTA_JvRfcommWrite*/
...
{
    tBTA_JV_STATUS  status;     /* Whether the operation succeeded or failed. */
    UINT32          handle;     /* The newly created SDP record handle */
...
typedef union
{
    ...
    tBTA_JV_SET_PM_PROFILE  set_pm;         /* BTA_JV_SET_PM_PROFILE_EVT */
    tBTA_JV_NOTIFY_PM_STATE_CHANGE  notify_pm;   /* BTA_JV_NOTIFY_PM_STATE_CHANGE_EVT */
    UINT32                  handle;         /* BTA_JV_L2CAP_DATA_IND_EVT
...
/* JAVA set power managerment callback */
typedef void (tBTA_JV_PM_CBACK)(tBTA_JV_EVT event, tBTA_JV *p_data);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvCancelDiscovery(void);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvCreateRecord(UINT16 *p_ids, UINT8 **p_values,
                           INT32 *p_value_sizes, INT32 array_len);
...
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JvRfcommStopServer(UINT8 local_scn);
...
**
** Description      This function set power mode for different JV application
**
** Parameters       handle,  JV handle from RFCOMM or L2CAP
**                  jv_id,   JV ID (BTA_JV_PM_ID_CLEAR is used to clear PM profile)
**                  c_back,  call back function for this API
**
** Returns          BTA_JV_SUCCESS, if the request is being processed.
**                  BTA_JV_FAILURE, otherwise.
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JVSetPmProfile(UINT32 handle, tBTA_JV_PM_ID jv_id, tBTA_JV_PM_CBACK *cback);


/*******************************************************************************
**
** Function         BTA_JVNotifyPmStateChange
**
** Description      This function notifies power manager there is state change
**                  PM will search PM lookup table to change the power mode accordingly
**
** Parameters       state,  JV connection state
**                  handle, JV handle from RFCOMM or L2CAP
**
** Returns          BTA_JV_SUCCESS, if the request is being processed.
**                  BTA_JV_FAILURE, otherwise.
**
*******************************************************************************/
BTA_API extern tBTA_JV_STATUS BTA_JVNotifyPmStateChange(tBTA_JV_CONN_STATE state, UINT32 handle);

...
**                 storage
**
** Parameters      mdep_id - MDEP ID for the specified medp_idx
...
**
*******************************************************************************/
BTA_API extern void bta_hl_co_save_mdl(UINT8 mdep_id, UINT8 item_idx, tBTA_HL_MDL_CFG *p_mdl_cfg );
/*******************************************************************************
**
...
**
*******************************************************************************/
BTA_API extern void bta_hl_co_delete_mdl(UINT8 mdep_id, UINT8 item_idx);
/*******************************************************************************
**

...
#define BTM_CLB_TRUNC_PAGE_RCV_EVT      9   /* A peer device performed Truncated Page (Sync Train Req) */ /* BSA_SPECIFIC */
#if (defined(BT_BRCM_VS_INCLUDED) && (BT_BRCM_VS_INCLUDED == TRUE)) /* BSA_SPECIFIC */
#define BTM_CLB_STREAM_TX_CFM_EVT       10   /* CLB Stream Tx cfm (result of Data Tx on a Tx Stream channel) */
#endif  /* BT_BRCM_VS_INCLUDED == TRUE */
...
#define BTM_CLB_MODE_RX                 0x02    /* No need to reserve Lt_Addr */ /* BSA_SPECIFIC */
#if (defined(BT_BRCM_VS_INCLUDED) && (BT_BRCM_VS_INCLUDED == TRUE)) /* BSA_SPECIFIC */
#define BTM_CLB_MODE_STREAM             0x04    /* Proprietary Stream Mode */
#endif  /* BT_BRCM_VS_INCLUDED == TRUE */

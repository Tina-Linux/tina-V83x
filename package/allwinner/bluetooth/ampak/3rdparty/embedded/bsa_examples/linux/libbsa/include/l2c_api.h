...
#define L2CAP_MIN_OFFSET    15     /* plus extended control(4), SDU length(2) */
#else
...
#if AMP_INCLUDED == TRUE
/* note: we do not usually include a header file in the middle of a file
 *       However, amp_api.h uses some definition (tL2CAP_CFG_INFO for example )in l2c_api.h.
 *       we can not move this include to too early in this l2c_api.h */
#include "amp_api.h"

#define L2CA_REGISTER(a,b,c)        AMP_Register(a,(tAMP_APPL_INFO *)b,c)
#define L2CA_DEREGISTER(a)          AMP_Deregister(a)
#define L2CA_CONNECT_REQ(a,b,c,d)   AMP_ConnectReq(a,b,c,d)
#define L2CA_CONNECT_RSP(a,b,c,d,e,f,g) AMP_ConnectRsp(a,b,c,d,e,f,g)
#define L2CA_CONFIG_REQ(a,b)        AMP_ConfigReq(a,b)
#define L2CA_CONFIG_RSP(a,b)        AMP_ConfigRsp(a,b)
#define L2CA_DISCONNECT_REQ(a)      AMP_DisconnectReq(a)
#define L2CA_DISCONNECT_RSP(a)      AMP_DisconnectRsp(a)
#define L2CA_DATA_WRITE(a, b)       AMP_DataWrite(a, b)
#else
...
**
*/
typedef void (tL2CA_LE_CONNECT_IND_CB) (BD_ADDR, UINT16, UINT16, UINT8, UINT16);
...
**              MTU of the peer
*/
typedef void (tL2CA_LE_CONNECT_CFM_CB) (UINT16, UINT16, UINT16);
...
**
*******************************************************************************/
L2C_API extern UINT16 L2CA_LeRegister (UINT16 le_psm, tL2CAP_LE_APPL_INFO *p_cb_info);
...
/*******************************************************************************
**
** Function         L2CA_ClearUnackCounter
**
** Description      Clear unack counter and flush ACL data buffer
**                  when WLAN independent reset triggered
**
** Returns
**
*******************************************************************************/
L2C_API extern void L2CA_ClearUnackCounter(void);
#endif

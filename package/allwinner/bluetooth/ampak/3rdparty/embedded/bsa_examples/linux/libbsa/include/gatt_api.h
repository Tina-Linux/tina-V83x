...
#define  GATT_OP_CODE_MAX                    0x1F /* 0x1F = GATT_HANDLE_VALUE_CONF + 1 = 31*/ /* BSA_SPECIFIC */
...
*/
#ifndef GATT_DEF_BLE_MTU_SIZE /* BSA_SPECIFIC */
...
typedef void (tGATT_CONN_CBACK) (tGATT_IF gatt_if, BD_ADDR bda, UINT16 conn_id, BOOLEAN connected, tGATT_DISCONN_REASON reason, tBT_TRANSPORT transport);

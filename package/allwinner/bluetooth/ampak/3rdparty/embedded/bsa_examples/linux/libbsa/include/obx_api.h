...
typedef union
{
    ...
    UINT8               ctrl_id;    /* Controller ID BREDR = 0, AMP = 1, 2, ... */
#endif
} tOBX_EVT_PARAM;
...
/*******************************************************************************
**
** Function     OBX_ChangeCriteria
**
** Description  This function is called to change the criteria for an
**              existing AMP connection.
**
** Returns      void.
**
*******************************************************************************/
OBX_API extern void OBX_ChangeCriteria(tOBX_HANDLE shandle, tAMP_CRITERIA new_criteria);

/*******************************************************************************
**
** Function     OBX_GetControllerId
**
** Description  This function is called to get current controller ID
**
** Returns      Controller ID: 0 for Br/EDR, the other for AMP
**
*******************************************************************************/
OBX_API extern UINT8 OBX_GetControllerId(tOBX_HANDLE shandle);

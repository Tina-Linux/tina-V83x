...
#ifndef     BTA_GATT_VERBOSE_DEBUG
#define     BTA_GATT_VERBOSE_DEBUG  FALSE
#endif
...
#define  BTA_GATT_INVALID_HANDLE            GATT_INVALID_HANDLE                /* 0x01 */
#define  BTA_GATT_READ_NOT_PERMIT           GATT_READ_NOT_PERMIT               /* 0x02 */
#define  BTA_GATT_WRITE_NOT_PERMIT          GATT_WRITE_NOT_PERMIT              /* 0x03 */
#define  BTA_GATT_INVALID_PDU               GATT_INVALID_PDU                   /* 0x04 */
#define  BTA_GATT_INSUF_AUTHENTICATION      GATT_INSUF_AUTHENTICATION          /* 0x05 */
#define  BTA_GATT_REQ_NOT_SUPPORTED         GATT_REQ_NOT_SUPPORTED             /* 0x06 */
#define  BTA_GATT_INVALID_OFFSET            GATT_INVALID_OFFSET                /* 0x07 */
#define  BTA_GATT_INSUF_AUTHORIZATION       GATT_INSUF_AUTHORIZATION           /* 0x08 */
#define  BTA_GATT_PREPARE_Q_FULL            GATT_PREPARE_Q_FULL                /* 0x09 */
#define  BTA_GATT_NOT_FOUND                 GATT_NOT_FOUND                     /* 0x0a */
#define  BTA_GATT_NOT_LONG                  GATT_NOT_LONG                      /* 0x0b */
#define  BTA_GATT_INSUF_KEY_SIZE            GATT_INSUF_KEY_SIZE                /* 0x0c */
#define  BTA_GATT_INVALID_ATTR_LEN          GATT_INVALID_ATTR_LEN              /* 0x0d */
#define  BTA_GATT_ERR_UNLIKELY              GATT_ERR_UNLIKELY                  /* 0x0e */
#define  BTA_GATT_INSUF_ENCRYPTION          GATT_INSUF_ENCRYPTION              /* 0x0f */
#define  BTA_GATT_UNSUPPORT_GRP_TYPE        GATT_UNSUPPORT_GRP_TYPE            /* 0x10 */
#define  BTA_GATT_INSUF_RESOURCE            GATT_INSUF_RESOURCE                /* 0x11 */
...
#define  BTA_GATT_DUP_REG                   0x90                                /* 0x8f */
#define  BTA_GATT_ALREADY_OPEN              0x91                                /* 0x90 */
#define  BTA_GATT_CANCEL                    0x92                                /* 0x91 */
...
#define BTA_GATTC_CONGEST_EVT       18  /* congestion/uncongestion event */

typedef UINT8 tBTA_GATTC_EVT;

#define BTA_GATTC_EVT_MAX           BTA_GATTC_CFG_MTU_EVT

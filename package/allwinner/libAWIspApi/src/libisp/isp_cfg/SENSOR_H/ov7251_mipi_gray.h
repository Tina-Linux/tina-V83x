...
#ifndef _ov7251_MIPI_H_V100_
#define _ov7251_MIPI_H_V100_

#include "../../include/isp_ini_parse.h"

struct isp_test_param ov7251_mipi_isp_test_settings = {
	.isp_test_mode = 0,
	.isp_test_exptime = 0,
	.exp_line_start = 1000,
	.exp_line_step = 1000,
...
struct isp_3a_param ov7251_mipi_isp_3a_settings = {
	.define_ae_table = 1,
	.ae_max_lv = 1650,
...
struct isp_dynamic_param ov7251_mipi_isp_iso_settings = {
	.triger = {
		.sharp_triger = 1,
		.contrast_triger = 1,
		.denoise_triger = 1,
	...
	.isp_dynamic_cfg[0] = {
		...
		.color_denoise = 4,
		.ae_cfg = {
			512, 192, 256, 256, 12, 12, 12, 12, 3, 42, 4, 12, 22, 64
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[2] = {
		...
		.color_denoise = 32,
		.ae_cfg = {
			380, 192, 256, 256, 12, 12, 12, 12, 3, 42, 4, 12, 22, 64
		},
		.gtm_cfg = {
			1024, 22, 22, 5, 215, 1, 7, 1, -2
		},
	...
	.isp_dynamic_cfg[3] = {
		...
		.color_denoise = 50,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 44, 4, 12, 16, 64
		},
		.gtm_cfg = {
			1024, 22, 22, 5, 215, 1, 7, 1, -2
		},
	...
	.isp_dynamic_cfg[4] = {
		...
		.color_denoise = 80,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 44, 4, 16, 12, 48
		},
		.gtm_cfg = {
			1024, 22, 22, 5, 215, 1, 7, 1, -2
		},
	...
	.isp_dynamic_cfg[5] = {
		...
		.color_denoise = 120,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 44, 4, 24, 8, 32
		},
		.gtm_cfg = {
			1024, 22, 22, 5, 215, 1, 7, 1, -2
		},
	...
	.isp_dynamic_cfg[6] = {
		...
		.color_denoise = 160,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 44, 4, 30, 6, 25
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[7] = {
		...
		.color_denoise = 100,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 44, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[10] = {
		...
		.color_denoise = 166,
		.ae_cfg = {
			256, 192, 256, 256, 12, 12, 12, 12, 3, 46, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
...
struct isp_tunning_param ov7251_mipi_isp_tuning_settings = {
	.flash_gain = 80,
...
struct isp_cfg_pt ov7251_mipi_isp_cfg = {
	.isp_test_settings = &ov7251_mipi_isp_test_settings,
	.isp_3a_settings = &ov7251_mipi_isp_3a_settings,
	.isp_tunning_settings = &ov7251_mipi_isp_tuning_settings,
	.isp_iso_settings = &ov7251_mipi_isp_iso_settings
};


#endif /* end of _ov7251_MIPI_H_V100_ */

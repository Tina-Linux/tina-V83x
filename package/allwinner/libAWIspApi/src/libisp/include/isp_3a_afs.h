...
typedef enum isp_afs_param_type {
	...
	ISP_AFS_FRAME_ID,
	ISP_AFS_AUTO_FLAG,
	ISP_AFS_FLICKER_RATIO,
	ISP_AFS_FLICKER_TPYE_CONFIG,
	ISP_AFS_SENSOR_INFO,
	ISP_AFS_TEST_CONFIG,
	ISP_AFS_FLICKER_MODE,
...
typedef struct isp_afs_core_ops {
	HW_S32 (*isp_afs_set_params)(void * afs_core_obj, afs_param_t *param,\
						afs_result_t *result);
	HW_S32 (*isp_afs_get_params)(void *afs_core_obj, afs_param_t *param);
	HW_S32 (*isp_afs_run)(void *afs_core_obj, afs_stats_t *stats,\
						afs_result_t *result);
} isp_afs_core_ops_t;

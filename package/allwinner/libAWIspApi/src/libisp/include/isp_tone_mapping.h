...
typedef enum isp_gtm_param_type {
	...
	ISP_GTM_CONTRAST,
	ISP_GTM_BRIGHTNESS,
	ISP_GTM_BRIGHT_PIXEL_VALUE,
	ISP_GTM_DARK_PIXEL_VALUE,

	ISP_GTM_GAMMA_TBL,
	ISP_GTM_DRC_TBL,
	ISP_GTM_DRC_TBL_LAST,
	ISP_GTM_TEST_CONFIG,
...
typedef struct isp_gtm_core_ops {
	int (*isp_gtm_set_params)(void * gtm_core_obj, gtm_param_t *param,\
						gtm_result_t *result);
	int (*isp_gtm_get_params)(void *gtm_core_obj, gtm_param_t *param);
	int (*isp_gtm_run)(void *gtm_core_obj, gtm_stats_t *stats,\
						gtm_result_t *result);
} isp_gtm_core_ops_t;

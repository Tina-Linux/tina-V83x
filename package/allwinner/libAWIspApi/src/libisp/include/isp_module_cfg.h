...
struct isp_module_config {
	...
	struct isp_bdnf_config bdnf_cfg;
	...
	struct isp_otf_dc_config otf_cfg;
...
enum isp_features_flags {
	...
	ISP_FEATURES_OTF_DPC    =  (1 << 3) ,
	ISP_FEATURES_BDNF       =  (1 << 4) ,
	ISP_FEATURES_3D_DENOISE =  (1 << 5) ,
	ISP_FEATURES_AWB	=  (1 << 6) ,
	ISP_FEATURES_WB         =  (1 << 7) ,
	ISP_FEATURES_LSC        =  (1 << 8) ,
	ISP_FEATURES_GAMMA      =  (1 << 9) ,
	ISP_FEATURES_SAP        =  (1 << 10),

...
typedef struct ISP_TO_HAL_PARAMS_t{
	IMAGE_FLAG_t image_para;
} isp_to_hal_params;

typedef struct HAL_TO_ISP_PARAMS_t{
	IMAGE_FLAG_t image_para;
} hal_to_isp_params;

typedef struct ISP_HAL_PARAMS_t{
	isp_to_hal_params ith_params;
	hal_to_isp_params hti_params;
} isp_hal_params;

...
enum {
	...
	LE_IRK_OR_PUBLIC_ADDRESS = 0x02,
	LE_IRK_OR_RANDOM_ADDRESS = 0x03,
	LE_ADDRESS_MAX = 0x04,
};

/*LE peer address type*/
enum {
	LE_PEER_PUBLIC_ADDRESS = 0x00, /*public device address(default) or public indentiy address*/
	LE_PEER_RANDOM_ADDRESS = 0x01, /*random device address(default) or random indentiy address*/
	LE_PEER_ADDRESS_MAX = 0x02,
};

/*LE advertising type*/
enum {
	LE_ADV_IND = 0x00, /*connectable and scannable undirected advertising*/
	LE_ADV_DIRECT_HIGH_IND = 0x01, /*connectable high duty cycle directed advertising*/
	LE_ADV_SCAN_IND = 0x02, /*scannable undirected advertising*/
	LE_ADV_NONCONN_IND = 0x03, /*non connectable undirected advertising*/
	LE_ADV_DIRECT_LOW_IND = 0x04, /*connectable low duty cycle directed advertising*/
	LE_ADV_TYPE_MAX = 0x05,
};

/*LE advertising filter policy*/
enum {
	LE_PROCESS_ALL_REQ = 0x00, /*process scan and connection requests from all devices*/
	LE_PROCESS_CONN_REQ = 0x01, /*process connection request from all devices and scan request only from white list*/
	LE_PROCESS_SCAN_REQ = 0x02, /*process scan request from all devices and connection request only from white list*/
	LE_PROCESS_WHITE_LIST_REQ = 0x03, /*process requests only from white list*/
	LE_FILTER_POLICY_MAX = 0x04,
};

#define LE_ADV_CHANNEL_NONE 0x00
#define LE_ADV_CHANNEL_37 0x01
#define LE_ADV_CHANNEL_38 (0x01 << 1)
#define LE_ADV_CHANNEL_39 (0x01 << 2)
#define LE_ADV_CHANNEL_ALL (LE_ADV_CHANNEL_NONE | LE_ADV_CHANNEL_37 | LE_ADV_CHANNEL_38 | LE_ADV_CHANNEL_39)

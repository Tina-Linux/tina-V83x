...
/*to config the path(a dir or a file) with default file configuration
*path: the path to be configured
*dir:  figure out the path is a directory or a file
*uid/gid/mode/capabilities: the configuration to acquire
*/

...
void print_help(){
    ...
    wmg_printf(MSG_INFO,"\twifi_reconnect_ap_test --help\n");
    wmg_printf(MSG_INFO,"\twifi_reconnect_ap_test -h\n");
    wmg_printf(MSG_INFO,"\twifi_reconnect_ap_test -H\n");
    wmg_printf(MSG_INFO,"---------------------------------------------------------------------------------\n");
}
...
int main(int argv, char *argc[]){
    ...
    wmg_printf(MSG_DEBUG,"***Start wifi reconnect ap test\n");
    wmg_printf(MSG_DEBUG,"*********************************\n");
	...
	wmg_printf(MSG_INFO,"Wifi reconnect ap : Success!\n");
    else
	wmg_printf(MSG_ERROR,"Wifi reconnect ap : Failure!\n");

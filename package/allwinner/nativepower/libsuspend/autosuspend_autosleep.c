...
static int autosuspend_autosleep_enable(void)
{
	...
	TLOGV("autosuspend_autosleep_enable\n");
	...
	TLOGV("autosuspend_autosleep_enable done\n");
...
static int autosuspend_autosleep_disable(void)
{
	...
	TLOGV("autosuspend_autosleep_disable\n");
	...
	TLOGV("autosuspend_autosleep_disable done\n");

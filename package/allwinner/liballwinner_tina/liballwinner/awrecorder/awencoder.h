...
int            AwEncoderInit(AwEncoder* p, VideoEncodeConfig *videoConfig, AudioEncodeConfig *audioConfig,EncDataCallBackOps *ops);
...
int            AwEncoderSetNotifyCallback(AwEncoder* p, EncoderNotifyCallback notifier, void* pUserData);

...
typedef struct AwMessageNode AwMessageNode;
typedef struct AwMessageQueueContext AwMessageQueueContext;

struct AwMessageNode
{
    AwMessage      msg;
    struct AwMessageNode* next;
    int            valid;
};

struct AwMessageQueueContext
{
    AwMessageNode*  pHead;
    int             nCount;
    AwMessageNode*  Nodes;

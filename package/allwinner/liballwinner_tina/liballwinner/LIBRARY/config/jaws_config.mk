...
NON_H265_4K_NOT_SCALE_DOWN := 1
SUPPORT_H265 := 0
ANTUTU_NOT_SUPPORT := 0
ENABLE_MEDIA_BOOST := 0
DROP_DELAY_FRAME = $(DROP_DELAY_FRAME_720P)
ROTATE_PIC_HW := 0
VE_PHY_OFFSET := 0x20000000
ZEROCOPY_PIXEL_FORMAT = $(ZEROCOPY_PIXEL_FORMAT_YUV_MB32_420)
...
DEINTERLACE_IOWR := 0
DEINTERLACE_FORMAT = $(DEINTERLACE_FORMAT_MB32_12)
NEW_DISPLAY_DOUBLE_STREAM_NEED_NV21 := 0
OUTPUT_PIXEL_FORMAT = $(OUTPUT_PIXEL_FORMAT_NV12)
NOT_DROP_FRAME := 0

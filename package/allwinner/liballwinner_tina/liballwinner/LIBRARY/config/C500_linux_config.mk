...
ENABLE_MEDIA_BOOST := 1
DROP_DELAY_FRAME = $(DROP_DELAY_FRAME_4K)
ROTATE_PIC_HW := 0
ZEROCOPY_PIXEL_FORMAT = $(ZEROCOPY_PIXEL_FORMAT_NV21)
GPU_Y_C_ALIGN = $(GPU_Y16_C16_ALIGN)
SEND_3_BLACK_FRAME_TO_GPU := 0
ZEROCOPY_DYNAMIC_CHECK := 1
GRALLOC_PRIV := 0
VIDEO_DIRECT_ACCESS_DE := 2
KEY_PARAMETER_GET := 1
DISPLAY_CMD_SETVIDEOSIZE_POSITION := 1
DEINTERLACE_IOWR := 0
DEINTERLACE_FORMAT = $(DEINTERLACE_FORMAT_NV)
NEW_DISPLAY_DOUBLE_STREAM_NEED_NV21 := 1
OUTPUT_PIXEL_FORMAT = $(OUTPUT_PIXEL_FORMAT_MB32)
NOT_DROP_FRAME := 1
...
########## configure ARM_VERSION ##########
LOCAL_CFLAGS += -DCONFIG_ARM_VERSION=$(ARM_VERSION)
...
ifeq ($(USE_NEW_DISPLAY), 1)
    ifeq ($(CONFIG_TARGET_PRODUCT), r58)

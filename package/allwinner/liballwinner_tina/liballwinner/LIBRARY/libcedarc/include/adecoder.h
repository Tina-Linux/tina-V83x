...
#define AUDIO_BITSTREAM_BUFFER_SIZE (1024*2048)
#define AUDIO_BITSTREAM_BUFFER_MAX_FRAME_NUM (2048)
#define AUDIO_PCM_BUFFER_SIZE (1024*1024)
...
#ifdef CONFIG_ADECODER_SUPPORT_SOUNDTOUCH

...
static cdx_void __CdxMetaClear(struct CdxMetaS *meta)
{
...
static cdx_void __CdxMetaDecRef(struct CdxMetaS *meta)
{
    struct CdxMetaImplS *impl;
...
static cdx_err __CdxMetaSetObject(struct CdxMetaS *meta, cdx_char *name, cdx_void *val)
{
    struct CdxMetaImplS *impl;

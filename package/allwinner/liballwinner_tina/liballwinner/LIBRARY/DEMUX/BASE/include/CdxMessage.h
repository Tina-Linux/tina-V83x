...
static inline cdx_void CdxMessageDecRef(CdxMessageT *msg)
{
    CDX_CHECK(msg);
    CDX_CHECK(msg->ops);
...
static inline cdx_void CdxMessageDeliver(CdxMessageT *msg)
{
    CDX_CHECK(msg);
    CDX_CHECK(msg->ops);
...
{
    cdx_void (*msgRecv)(CdxHandlerItfT *, CdxMessageT *);
};
...
struct CdxHandlerOpsS
{
    ...
    cdx_void (*msgRecv)(CdxHandlerT *, CdxMessageT *);
};
...
static inline cdx_void CdxHandlerMsgRecv(CdxHandlerT *hdr, CdxMessageT *msg)
{
    CDX_CHECK(hdr);
    CDX_CHECK(hdr->ops);

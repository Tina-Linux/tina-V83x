...
struct CdxMetaOpsS
{
    ...
    cdx_err (*setObject)(CdxMetaT *, cdx_char * /*name*/, cdx_void *);
...
static inline cdx_void CdxMetaDecRef(CdxMetaT  *meta)
{
    CDX_CHECK(meta);
    CDX_CHECK(meta->ops);
...
static inline cdx_err CdxMetaSetObject(CdxMetaT *meta, cdx_char *name, cdx_void *val)
{
    CDX_CHECK(meta);
    CDX_CHECK(meta->ops);
...
static inline cdx_void CdxMetaClear(CdxMetaT *meta)
{
    CDX_CHECK(meta);
    CDX_CHECK(meta->ops);

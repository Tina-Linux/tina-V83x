...
static inline cdx_void CdxBufferDecRef(CdxBufferT *buf)
{
    CDX_CHECK(buf);
    CDX_CHECK(buf->ops);
...
static inline cdx_void CdxBufferAppend(CdxBufferT *buf, const cdx_uint8 *data,
                                    cdx_uint32 len)
{
    CDX_CHECK(buf);
    CDX_CHECK(buf->ops);
...
static inline cdx_void CdxBufferInsert(CdxBufferT *buf,
...
static inline cdx_void CdxBufferSetRange(CdxBufferT *buf,
...
static inline cdx_void CdxBufferSeekRange(CdxBufferT *buf,

...
{
    FSWRITEMODE m_mode;
    cdx_int32 (*fsWrite)(CdxFsWriter *thiz, const cdx_int8 *buf, cdx_int32 size);
...
extern cdx_int32 FileWriter(CdxWriterT *p_writer, const cdx_int8 *buffer, cdx_int32 size);

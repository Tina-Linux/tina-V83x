...
int inflate_table(codetype type, unsigned short * lens, unsigned int codes,code ** table,
...
int updatewindow(z_stream * strm, unsigned int out)
{
...
int inflateInit(z_stream * strm, int windowBits)
{
    struct inflate_state *state;

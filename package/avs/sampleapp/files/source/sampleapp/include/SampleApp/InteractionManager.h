...
public:
    ...
    void setVolume(avsCommon::sdkInterfaces::SpeakerInterface::Type type, uint8_t volume);
    ...
    bool isMicrophoneOn(bool& isMicOn) {
        isMicOn = m_isMicOn;
        return true;
    }
private:
    ...
    std::shared_ptr<sampleApp::MicrophoneWrapperInterface> m_micWrapper;

...
typedef enum {
	DISP_BT601 = 0, DISP_BT709 = 1, DISP_YCC = 2,
} disp_color_space;

typedef enum {
	DISP_CSC_TYPE_RGB = 0, DISP_CSC_TYPE_YUV1 = 1, /* HDMI */
...
/* FIXME:still need? */
typedef enum {
	DISP_EXIT_MODE_CLEAN_ALL = 0, DISP_EXIT_MODE_CLEAN_PARTLY = 1, /* only clean interrupt temply */
} disp_exit_mode;
...
typedef enum {
	LAYER_MODE_BUFFER = 0, LAYER_MODE_COLOR = 1,
} disp_layer_mode;
...
typedef enum {
	DISP_TV_NONE = 0, DISP_TV_CVBS = 1, DISP_TV_YPBPR = 2, DISP_TV_SVIDEO = 4,
} disp_tv_output;

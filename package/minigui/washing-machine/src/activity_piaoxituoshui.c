...
static DoubleTextView* DoubleTextDataInit(DoubleTextView *doubleTextData,
	...
	case 1:
		...
		doubleTextData->valueUnitDes[3] = "8";
		doubleTextData->valueUnitDes[4] = FEN;
		doubleTextData->valueUnitDes[5] = TUOSHUI;
	...
	case 2:
		...
		break;
	case 3:
		doubleTextData->valueUnitDes[0] = DI;
		doubleTextData->valueUnitDes[1] = NULL;
		doubleTextData->valueUnitDes[2] = SHUIWEI;
...
static SlideTextView* SlideTextDataInit(SlideTextView *slideTextData, int num) {
	...
	case 1:
		...
		slideTextData->listData1[2] = "3";
		slideTextData->listData1[3] = ZIDONG;

		slideTextData->listData2[0] = "8";
		slideTextData->listData2[1] = "9";
		slideTextData->listData2[2] = "10";
		slideTextData->listData2[3] = "11";
		slideTextData->listData2[4] = "12";

		slideTextData->listSize1 = 4;
	...
	case 2:
		...
		break;
	case 3:
		slideTextData->listData1[0] = DI;
		slideTextData->listData1[1] = ZHONG;
		slideTextData->listData1[2] = GAO;
		...
		slideTextData->listData2[6] = "1400";
		slideTextData->listData2[7] = "1600";

		slideTextData->listSize1 = 3;
		slideTextData->listSize2 = 8;
		break;
	}
...
static void my_notif_proc(HWND hwnd, int id, int nc, DWORD add_data) {
	if (nc == STN_CLICKED) {
		features_menu(hwnd, 12);
	}
}

#define __ID_TIMER_SLIDER 100
static int ActivityPiaoXiTouShuiProc(HWND hWnd, int message, WPARAM wParam,
		LPARAM lParam) {
	...
	case MSG_CREATE: {
		setCurrentIconValue(ID_FUN_SCREEN_BG3, 0);
	...
	case MSG_PAINT: {
		...
		TextOut(hdc, 10, 150, PIAOXITUOSHUI);
		...
		rcClient.right = 400;
		rcClient.bottom = 400;
		DrawText(hdc, PIAOXITUOSHUI_N, -1, &rcClient,
...
int ActivityPiaoXiTouShui(HWND hosting, HeadBarView *myHeadBarData) {
	MSG Msg;
	HWND hMainWnd;
	...
	CreateInfo.hIcon = 0;
	CreateInfo.MainWindowProc = ActivityPiaoXiTouShuiProc;
	CreateInfo.lx = 0;
	CreateInfo.ty = 0;

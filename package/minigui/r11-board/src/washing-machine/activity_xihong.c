...
static SlideTextView* SlideTextDataInit(SlideTextView *slideTextData, int num) {
	...
	switch (num) {
	case 1:
		slideTextData->listData1[0] = "15";
		slideTextData->listData1[1] = "18";
		slideTextData->listData1[2] = "23";
		slideTextData->listData1[3] = "28";
		slideTextData->listData1[4] = "33";
	...
	case 2:
		...
		slideTextData->listData1[3] = "4";
		slideTextData->listData1[4] = ZIDONG;
		...
		slideTextData->listData2[5] = "95";

		slideTextData->listSize1 = 5;
		slideTextData->listSize2 = 6;
		break;
	case 3:
		slideTextData->listData1[0] = "5";
		slideTextData->listData1[1] = "6";
		slideTextData->listData1[2] = "7";
		slideTextData->listData1[3] = "8";
		slideTextData->listData1[4] = "9";
...
static void my_notif_proc(HWND hwnd, int id, int nc, DWORD add_data) {
	if (nc == STN_CLICKED) {
		features_menu(hwnd, 15);
	}
}

#define __ID_TIMER_SLIDER 100
static int ActivityXiHongProc(HWND hWnd, int message, WPARAM wParam,
		LPARAM lParam) {
	...
	case MSG_TIMER: {
		...
		headbarbtnwifi[15] = HeadBarViewInit(hWnd, bottomBar, headBarData);

		SendMessage(headbarbtnwifi[15], MSG_UPDATETIME, NULL, NULL);
	...
	case MSG_CREATE: {
		setCurrentIconValue(ID_FUN_SCREEN_BG3, 3);
	...
	case MSG_PAINT: {
		...
		rcClient.right = 400;
		rcClient.bottom = 400;
		DrawText(hdc, XIHONG60_N, -1, &rcClient,
...
int ActivityXiHong(HWND hosting, HeadBarView *myHeadBarData) {
	MSG Msg;
	HWND hMainWnd;
	...
	CreateInfo.hIcon = 0;
	CreateInfo.MainWindowProc = ActivityXiHongProc;
	CreateInfo.lx = 0;
	CreateInfo.ty = 0;

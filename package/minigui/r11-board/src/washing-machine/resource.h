...
static pthread_t pthread_wifi_on;
static pthread_t pthread_wifioff;
static pthread_t pthread_wifi_connect;
static pthread_t pthread_headbar_change;
static pthread_t pthread_time;
static pthread_t pthread_wifichange;
static pthread_t headbar_Init;
static pthread_t pthread_playerinit;
static pthread_t pthread_readplay;
static pthread_t pthread_disconnect_ap;

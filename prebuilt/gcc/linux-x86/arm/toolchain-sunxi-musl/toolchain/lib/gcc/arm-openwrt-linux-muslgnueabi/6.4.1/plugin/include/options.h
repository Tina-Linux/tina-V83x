...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 231,              /* -Werror-maybe-reset */
  ...
  OPT_fhonour_copts = 730,                   /* -fhonour-copts */
  ...
  OPT_mabi_ = 1184,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1185,             /* -mabort-on-noreturn */
  OPT_mandroid = 1186,                       /* -mandroid */
  OPT_mapcs = 1187,                          /* -mapcs */
  OPT_mapcs_frame = 1188,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1189,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1190,              /* -mapcs-stack-check */
  OPT_march_ = 1191,                         /* -march= */
  OPT_marm = 1192,                           /* -marm */
  OPT_masm_syntax_unified = 1193,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1194,                    /* -mbig-endian */
  OPT_mbionic = 1195,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1196,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1197,     /* -mcaller-super-interworking */
  OPT_mcmse = 1198,                          /* -mcmse */
  OPT_mcpu_ = 1199,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1200,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1201,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1202,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1203,                  /* -mfp16-format= */
  OPT_mfpu_ = 1204,                          /* -mfpu= */
  OPT_mglibc = 1205,                         /* -mglibc */
  /* OPT_mhard_float = 1206, */              /* -mhard-float */
  OPT_mlittle_endian = 1207,                 /* -mlittle-endian */
  OPT_mlong_calls = 1208,                    /* -mlong-calls */
  OPT_mmusl = 1209,                          /* -mmusl */
  OPT_mneon_for_64bits = 1210,               /* -mneon-for-64bits */
  ...
  OPT_mpure_code = 1215,                     /* -mpure-code */
  OPT_mrestrict_it = 1216,                   /* -mrestrict-it */
  OPT_msched_prolog = 1217,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1218,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1219,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1220, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1221,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1222,                         /* -mthumb */
  OPT_mthumb_interwork = 1223,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1224,                  /* -mtls-dialect= */
  OPT_mtp_ = 1225,                           /* -mtp= */
  OPT_mtpcs_frame = 1226,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1227,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1228,                         /* -mtune= */
  OPT_muclibc = 1229,                        /* -muclibc */
  OPT_munaligned_access = 1230,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1231,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1232,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1233,              /* -mword-relocations */
  OPT_n = 1234,                              /* -n */
  OPT_no_canonical_prefixes = 1235,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1236,              /* -no-integrated-cpp */
  OPT_no_pie = 1237,                         /* -no-pie */
  OPT_nocpp = 1238,                          /* -nocpp */
  OPT_nodefaultlibs = 1239,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1240,                   /* -nostartfiles */
  OPT_nostdinc = 1241,                       /* -nostdinc */
  OPT_nostdinc__ = 1242,                     /* -nostdinc++ */
  OPT_nostdlib = 1243,                       /* -nostdlib */
  OPT_o = 1244,                              /* -o */
  OPT_p = 1245,                              /* -p */
  OPT_pass_exit_codes = 1246,                /* -pass-exit-codes */
  /* OPT_pedantic = 1247, */                 /* -pedantic */
  OPT_pedantic_errors = 1248,                /* -pedantic-errors */
  OPT_pg = 1249,                             /* -pg */
  OPT_pie = 1250,                            /* -pie */
  OPT_pipe = 1251,                           /* -pipe */
  OPT_posix = 1252,                          /* -posix */
  OPT_print_file_name_ = 1253,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1254,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1255,          /* -print-multi-directory */
  OPT_print_multi_lib = 1256,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1257,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1258,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1259,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1260,               /* -print-prog-name= */
  OPT_print_search_dirs = 1261,              /* -print-search-dirs */
  OPT_print_sysroot = 1262,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1263,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1264,                        /* -profile */
  OPT_pthread = 1265,                        /* -pthread */
  OPT_quiet = 1266,                          /* -quiet */
  OPT_r = 1267,                              /* -r */
  OPT_rdynamic = 1268,                       /* -rdynamic */
  OPT_remap = 1269,                          /* -remap */
  OPT_s = 1270,                              /* -s */
  OPT_s_bc_abi = 1271,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1281,                  /* -static-libgcj */
  OPT_static_libgfortran = 1282,             /* -static-libgfortran */
  OPT_static_libgo = 1283,                   /* -static-libgo */
  OPT_static_liblsan = 1284,                 /* -static-liblsan */
  OPT_static_libmpx = 1285,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1286,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1287,               /* -static-libstdc++ */
  OPT_static_libtsan = 1288,                 /* -static-libtsan */
  OPT_static_libubsan = 1289,                /* -static-libubsan */
  ...
  OPT_std_c__98 = 1297,                      /* -std=c++98 */
  OPT_std_c11 = 1298,                        /* -std=c11 */
  /* OPT_std_c1x = 1299, */                  /* -std=c1x */
  /* OPT_std_c89 = 1300, */                  /* -std=c89 */
  OPT_std_c90 = 1301,                        /* -std=c90 */
  OPT_std_c99 = 1302,                        /* -std=c99 */
  /* OPT_std_c9x = 1303, */                  /* -std=c9x */
  OPT_std_f2003 = 1304,                      /* -std=f2003 */
  OPT_std_f2008 = 1305,                      /* -std=f2008 */
  OPT_std_f2008ts = 1306,                    /* -std=f2008ts */
  OPT_std_f95 = 1307,                        /* -std=f95 */
  OPT_std_gnu = 1308,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1309, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1310, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1311,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1312,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1313, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1314, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1315,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1316,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1317,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1318, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1319, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1320,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1321,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1322, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1323, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1324,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1325, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1326, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1327, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1328,                     /* -std=legacy */
  OPT_symbolic = 1329,                       /* -symbolic */
  OPT_t = 1330,                              /* -t */
  OPT_time = 1331,                           /* -time */
  OPT_time_ = 1332,                          /* -time= */
  OPT_tno_android_cc = 1333,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1334,                 /* -tno-android-ld */
  OPT_traditional = 1335,                    /* -traditional */
  OPT_traditional_cpp = 1336,                /* -traditional-cpp */
  OPT_trigraphs = 1337,                      /* -trigraphs */
  OPT_u = 1338,                              /* -u */
  OPT_undef = 1339,                          /* -undef */
  OPT_v = 1340,                              /* -v */
  OPT_version = 1341,                        /* -version */
  OPT_w = 1342,                              /* -w */
  OPT_wrapper = 1343,                        /* -wrapper */
  OPT_x = 1344,                              /* -x */
  OPT_z = 1345,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

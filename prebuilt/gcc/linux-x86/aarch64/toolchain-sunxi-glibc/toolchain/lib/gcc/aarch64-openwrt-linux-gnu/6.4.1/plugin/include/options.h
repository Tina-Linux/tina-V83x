...
enum opt_code
{
  ...
  OPT_mabi_ = 1184,                          /* -mabi= */
  OPT_march_ = 1185,                         /* -march= */
  OPT_mbig_endian = 1186,                    /* -mbig-endian */
  OPT_mbionic = 1187,                        /* -mbionic */
  OPT_mcmodel_ = 1188,                       /* -mcmodel= */
  OPT_mcpu_ = 1189,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1190,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1191,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1192,             /* -mgeneral-regs-only */
  OPT_mglibc = 1193,                         /* -mglibc */
  OPT_mlittle_endian = 1194,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1195,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1196,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1197,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1198,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1199,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1200,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1201,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1202,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1203,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1204,                     /* -mtls-size= */
  OPT_mtune_ = 1205,                         /* -mtune= */
  OPT_muclibc = 1206,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1207,             /* -mverbose-cost-dump */
  OPT_n = 1208,                              /* -n */
  ...
  OPT_s = 1244,                              /* -s */
  OPT_s_bc_abi = 1245,                       /* -s-bc-abi */
  OPT_save_temps = 1246,                     /* -save-temps */
  OPT_save_temps_ = 1247,                    /* -save-temps= */
  OPT_shared = 1248,                         /* -shared */
  OPT_shared_libgcc = 1249,                  /* -shared-libgcc */
  /* OPT_specs = 1250, */                    /* -specs */
  OPT_specs_ = 1251,                         /* -specs= */
  OPT_static = 1252,                         /* -static */
  OPT_static_libasan = 1253,                 /* -static-libasan */
  OPT_static_libgcc = 1254,                  /* -static-libgcc */
  OPT_static_libgcj = 1255,                  /* -static-libgcj */
  OPT_static_libgfortran = 1256,             /* -static-libgfortran */
  OPT_static_libgo = 1257,                   /* -static-libgo */
  OPT_static_liblsan = 1258,                 /* -static-liblsan */
  OPT_static_libmpx = 1259,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1260,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1261,               /* -static-libstdc++ */
  OPT_static_libtsan = 1262,                 /* -static-libtsan */
  OPT_static_libubsan = 1263,                /* -static-libubsan */
  /* OPT_std_c__03 = 1264, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1265, */                /* -std=c++0x */
  OPT_std_c__11 = 1266,                      /* -std=c++11 */
  OPT_std_c__14 = 1267,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1268, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1269, */                /* -std=c++1y */
  OPT_std_c__1z = 1270,                      /* -std=c++1z */
  OPT_std_c__98 = 1271,                      /* -std=c++98 */
  OPT_std_c11 = 1272,                        /* -std=c11 */
  /* OPT_std_c1x = 1273, */                  /* -std=c1x */
  /* OPT_std_c89 = 1274, */                  /* -std=c89 */
  OPT_std_c90 = 1275,                        /* -std=c90 */
  OPT_std_c99 = 1276,                        /* -std=c99 */
  /* OPT_std_c9x = 1277, */                  /* -std=c9x */
  OPT_std_f2003 = 1278,                      /* -std=f2003 */
  OPT_std_f2008 = 1279,                      /* -std=f2008 */
  OPT_std_f2008ts = 1280,                    /* -std=f2008ts */
  OPT_std_f95 = 1281,                        /* -std=f95 */
  OPT_std_gnu = 1282,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1283, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1284, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1285,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1286,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1287, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1288, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1289,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1290,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1291,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1292, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1293, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1294,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1295,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1296, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1297, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1298,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1299, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1300, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1301, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1302,                     /* -std=legacy */
  OPT_symbolic = 1303,                       /* -symbolic */
  OPT_t = 1304,                              /* -t */
  OPT_time = 1305,                           /* -time */
  OPT_time_ = 1306,                          /* -time= */
  OPT_traditional = 1307,                    /* -traditional */
  OPT_traditional_cpp = 1308,                /* -traditional-cpp */
  OPT_trigraphs = 1309,                      /* -trigraphs */
  OPT_u = 1310,                              /* -u */
  OPT_undef = 1311,                          /* -undef */
  OPT_v = 1312,                              /* -v */
  OPT_version = 1313,                        /* -version */
  OPT_w = 1314,                              /* -w */
  OPT_wrapper = 1315,                        /* -wrapper */
  OPT_x = 1316,                              /* -x */
  OPT_z = 1317,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

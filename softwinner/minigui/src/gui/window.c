        ...
        const char* window_name, const char* layer_name)
{
  ...
  //  fprintf(stderr,"CreateMainWindowEx  run 11");
...
#endif
   // fprintf(stderr,"CreateMainWindowEx  run 33");
...
#endif
        pWin->hSysMenu = 0;
    //fprintf(stderr,"CreateMainWindowEx  run 44");
    ...
    pWin->dwAddData2  = 0;
    pWin->secondaryDC = 0;
   // fprintf(stderr,"CreateMainWindowEx  run 55");
   ...
   // fprintf(stderr,"CreateMainWindowEx  run 66");
    ...
    //fprintf(stderr,"CreateMainWindowEx  run 77");
    ...
    //fprintf(stderr,"CreateMainWindowEx  run 88");

    if (SendMessage ((HWND)pWin, MSG_NCCREATE, 0, (LPARAM)pCreateInfo))
        goto err;
    //fprintf(stderr,"CreateMainWindowEx  run 99\n");
    /*remove restMenusize to fix crash isssue add by jason_yin 20190227*/
    /** reset menu size */
   // ResetMenuSize ((HWND)pWin);
   // fprintf(stderr,"CreateMainWindowEx  run 1010\n");
   ...
   // fprintf(stderr,"CreateMainWindowEx  run 1111\n");

    SendMessage ((HWND)pWin, MSG_CHANGESIZE, (WPARAM)&pWin->left, 0);
   // fprintf(stderr,"CreateMainWindowEx  run 2222\n");
    pWin->pGCRInfo = &pWin->GCRInfo;
  //  fprintf(stderr,"CreateMainWindowEx  run 3333\n");
     ...
     * child windows.
     */
     fprintf(stderr,"CreateMainWindowEx  run 1313");

# Makefile for eyesee-mpp/middleware/media/tina_mpp_vi
CUR_PATH := .
PACKAGE_TOP := ..
...
LOCAL_TARGET_DYNAMIC := libmpp_vi
endif
LOCAL_TARGET_STATIC :=
LOCAL_TARGET_BIN :=
...
LOCAL_DYNAMIC_LDFLAGS := $(LOCAL_LDFLAGS) -shared \
    -L $(EYESEE_MPP_LIBDIR) \
    -L $(PACKAGE_TOP)/media/LIBRARY/libisp \
    -Wl,-Bstatic \
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-tina_mpp_vi done
	@echo ===================================

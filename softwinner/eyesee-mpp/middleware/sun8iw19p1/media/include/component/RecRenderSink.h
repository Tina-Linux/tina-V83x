...
typedef struct RecSink
{
    ...
    BOOL                bTimeMeetAudio; //audio is enough to switch file.
    int                 mVideoFrmCntWriteMore;  //the frame number which video is written more.
    int64_t             mVideoPtsWriteMoreSt;   //framePts to start to write more.
    int64_t             mVideoPtsWriteMoreEnd;  //framePts to end.

# Makefile for eyesee-mpp/middleware/media/LIBRARY/AudioLib/midware/decoding
CUR_PATH := .
PACKAGE_TOP := ../../../../..
...
#include $(CUR_PATH)/../libcedarx/config.mk
...
INCLUDE_DIRS := \
    ...
    $(EYESEE_MPP_INCLUDE)/system/public/include/cutils \
...
LOCAL_TARGET_DYNAMIC := libadecoder
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libadecoder
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(CEDARX_CFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall \
    -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-function -D__OS_LINUX
#Extra flags to give to the C++ compiler
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-AudioLib-midware-decoding done
	@echo ===================================

# Makefile for eyesee-mpp/middleware/media/LIBRARY/libmuxer/raw_muxer
CUR_PATH := .
PACKAGE_TOP := ../../../..
...
LOCAL_TARGET_STATIC := libraw_muxer
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libmuxer-raw_muxer done
	@echo ===================================

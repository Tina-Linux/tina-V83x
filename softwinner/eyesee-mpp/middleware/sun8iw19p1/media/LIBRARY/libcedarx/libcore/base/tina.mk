# Makefile for eyesee-mpp/middleware/media/LIBRARY/libcedarx/libcore/base
CUR_PATH := .
PACKAGE_TOP := ../../../../..
...
LOCAL_TARGET_DYNAMIC := libcdx_base
LOCAL_TARGET_STATIC :=
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libcedarx-libcore-base done
	@echo ===================================

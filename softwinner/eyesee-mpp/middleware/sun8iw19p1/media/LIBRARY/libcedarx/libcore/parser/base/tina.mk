...
LOCAL_DYNAMIC_LDFLAGS := $(LOCAL_LDFLAGS) -shared \
    -L $(EYESEE_MPP_LIBDIR) \
    -L $(CEDARX_ROOT)/libcore/base \
    -L $(CEDARX_ROOT)/libcore/stream/base \
    -L $(CEDARX_ROOT)/libcore/parser/aac \
    -L $(CEDARX_ROOT)/libcore/parser/id3v2 \
    -L $(CEDARX_ROOT)/libcore/parser/mp3 \
    -L $(CEDARX_ROOT)/libcore/parser/mov \
    -L $(CEDARX_ROOT)/libcore/parser/mpg \
    -L $(CEDARX_ROOT)/libcore/parser/ts \
    -Wl,-Bstatic \

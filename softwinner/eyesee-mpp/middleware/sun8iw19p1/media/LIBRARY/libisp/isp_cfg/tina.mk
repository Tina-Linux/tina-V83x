...
ifeq ($(strip $(SENSOR_NAME)), sc2232)
    LOCAL_CFLAGS += -DSENSOR_SC2232=1
    LOCAL_CXXFLAGS += -DSENSOR_SC2232=1
endif
ifeq ($(strip $(SENSOR_NAME)), imx335)
    LOCAL_CFLAGS += -DSENSOR_IMX335=1
    LOCAL_CXXFLAGS += -DSENSOR_IMX335=1
endif
ifeq ($(strip $(SENSOR_NAME)), gc2053)

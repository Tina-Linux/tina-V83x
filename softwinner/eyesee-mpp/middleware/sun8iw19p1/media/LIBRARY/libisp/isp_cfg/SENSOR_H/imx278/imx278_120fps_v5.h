...
#ifndef _IMX278_120FPS_H_V100_
#define _IMX278_120FPS_H_V100_

#include "../../include/isp_ini_parse.h"

struct isp_test_param imx278_120fps_test_settings = {
	.isp_test_mode = 0,
	.isp_test_exptime = 0,
	.exp_line_start = 160,
	.exp_line_step = 32,
...
struct isp_3a_param imx278_120fps_3a_settings = {
	.define_ae_table = 1,
	.ae_max_lv = 1650,
...
struct isp_dynamic_param imx278_120fps_iso_settings = {
	.triger = {
		.sharp_triger = 1,
		.contrast_triger = 1,
		.denoise_triger = 1,
	...
	.isp_dynamic_cfg[0] = {
		...
		.color_denoise = 1,
		.ae_cfg = {
			128, 512, 128, 256, 48, 48, 48, 48, 3, 100, 4, 30, 2, 25
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[3] = {
		...
		.color_denoise = 8,
		.ae_cfg = {
			256, 512, 256, 256, 48, 48, 48, 48, 3, 100, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[4] = {
		...
		.color_denoise = 12,
		.ae_cfg = {
			256, 512, 256, 256, 48, 48, 48, 48, 3, 95, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[5] = {
		...
		.color_denoise = 16,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 90, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[6] = {
		...
		.color_denoise = 20,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 85, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[7] = {
		...
		.color_denoise = 24,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 80, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[8] = {
		...
		.color_denoise = 28,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 75, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[9] = {
		...
		.color_denoise = 54,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 70, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[10] = {
		...
		.color_denoise = 66,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 65, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[11] = {
		...
		.color_denoise = 77,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 60, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[12] = {
		...
		.color_denoise = 88,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 55, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
	...
	.isp_dynamic_cfg[13] = {
		...
		.color_denoise = 99,
		.ae_cfg = {
			256, 192, 256, 256, 48, 48, 48, 48, 3, 50, 4, 30, 2, 25
		},
		.gtm_cfg = {
			1024, 50, 10, 13, 215, 1, 7, 1, 0
		},
...
struct isp_tunning_param imx278_120fps_tuning_settings = {
	.flash_gain = 80,
...
struct isp_cfg_pt imx278_120fps_v5 = {
	.isp_test_settings = &imx278_120fps_test_settings,
	.isp_3a_settings = &imx278_120fps_3a_settings,
	.isp_tunning_settings = &imx278_120fps_tuning_settings,
	.isp_iso_settings = &imx278_120fps_iso_settings
};


#endif /* end of _IMX278_120FPS_H_V100_ */
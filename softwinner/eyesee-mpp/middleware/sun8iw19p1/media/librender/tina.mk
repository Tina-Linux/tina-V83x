# Makefile for eyesee-mpp/middleware/media/librender
CUR_PATH := .
PACKAGE_TOP := ../..
...
LOCAL_TARGET_DYNAMIC := libcedarxrender
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libcedarxrender
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -Wno-multichar
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -Wno-multichar
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-librender done
	@echo ===================================

# Makefile for eyesee-mpp/external/civetweb
CUR_PATH := .
PACKAGE_TOP := ..
...
LOCAL_TARGET_DYNAMIC := libjsoncpp0.8
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libjsoncpp0.8
endif
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) -fPIC -Wall \
        -Os -Wextra -Wshadow -Wformat-security -Winit-self -Wmissing-prototypes \
        -DLINUX -DNO_SSL -DUSE_STACK_SIZE=102400
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) -fPIC -Wall \
        -Os -Wextra -Wshadow -Wformat-security -Winit-self \
        -DLINUX -DNO_SSL -DUSE_STACK_SIZE=102400 \
        -fexceptions \
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-external-jsoncpp-lib done
	@echo ===================================

# Makefile for eyesee-mpp/external/fsck_msdos
CUR_PATH := .
PACKAGE_TOP := ..
...
all: $(LOCAL_TARGET_BIN)
	@echo ===================================
	@echo build eyesee-mpp-external-fsck_msdos done
	@echo ===================================
...
.PHONY: clean
clean:
	-rm -f $(OBJS) $(target_dynamic) $(target_static) $(LOCAL_TARGET_BIN)

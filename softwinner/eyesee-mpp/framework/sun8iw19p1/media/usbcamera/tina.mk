# Makefile for eyesee-mpp/framework/media/usbcamera
CUR_PATH := .
PACKAGE_TOP := ../..
...
INCLUDE_DIRS := \
    ...
    $(EYESEE_MPP_INCLUDE)/middleware/media/include/videoIn \
...
ifeq ($(MPPCFG_UVC),Y)
LOCAL_TARGET_STATIC := libusbcamera
endif
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-framework-media-usbcamera done
	@echo ===================================

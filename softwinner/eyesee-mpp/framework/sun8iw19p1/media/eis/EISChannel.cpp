...
EISChannel::DoPreviewThread::DoPreviewThread(EISChannel *pEisChn): mpEisChn(pEisChn)
{
}
...
EISChannel::DoPictureThread::DoPictureThread(EISChannel *pEisChn): mpEisChn(pEisChn)
{
}

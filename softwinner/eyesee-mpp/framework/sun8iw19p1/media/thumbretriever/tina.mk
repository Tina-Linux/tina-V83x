# Makefile for eyesee-mpp/framework/media/thumbretriever
CUR_PATH := .
PACKAGE_TOP := ../..
...
LOCAL_TARGET_STATIC := libthumbretriever
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-framework-media-thumbretriever done
	@echo ===================================

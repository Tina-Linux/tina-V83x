...
status_t PreviewWindow::setPreviewRegion(RECT_S pParamRegion)
{
    status_t ret = NO_ERROR;
    AutoMutex locker(mLock);
    mUserRegion_Ro.X = pParamRegion.X;
    mUserRegion_Ro.Y = pParamRegion.Y;
    mUserRegion_Ro.Width = pParamRegion.Width;
    mUserRegion_Ro.Height = pParamRegion.Height;
    mUserRegionFlag = true;
    return ret;
}
...
//        }
        ...
        if(mUserRegionFlag == true || mbFirstFrame == true)
        {

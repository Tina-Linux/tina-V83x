...
int main(int argc, char *argv[])
{
    ...
    stContext.mMainMuxerId = stContext.mpMainRecorder->addOutputFormatAndOutputSink(MEDIA_FILE_FORMAT_MP4, (char*)strSegmentFilePath.c_str(), 0, false);
    stContext.mMainSegmentFiles.push_back(strSegmentFilePath);
    alogd("setVideoFrameRate=[%d]", stContext.mConfigPara.mFrameRate);
    stContext.mpMainRecorder->setVideoFrameRate(stContext.mConfigPara.mFrameRate);
    alogd("setEncodeVideoSize=[%dx%d]", stContext.mConfigPara.mMainEncodeWidth, stContext.mConfigPara.mMainEncodeHeight);
    stContext.mpMainRecorder->setVideoSize(stContext.mConfigPara.mMainEncodeWidth, stContext.mConfigPara.mMainEncodeHeight);
    stContext.mpMainRecorder->setVideoEncoder(stContext.mConfigPara.mEncodeType);
    stContext.mpMainRecorder->setVideoEncodingBitRate(stContext.mConfigPara.mMainEncodeBitrate);
    ...
    stContext.mSubMuxerId = stContext.mpSubRecorder->addOutputFormatAndOutputSink(MEDIA_FILE_FORMAT_MP4, (char*)strSegmentFilePath.c_str(), 0, false);
    stContext.mSubSegmentFiles.push_back(strSegmentFilePath);
    alogd("setVideoFrameRate=[%d]", stContext.mConfigPara.mFrameRate);
    stContext.mpSubRecorder->setVideoFrameRate(stContext.mConfigPara.mFrameRate);
    alogd("setEncodeVideoSize=[%dx%d]", stContext.mConfigPara.mSubEncodeWidth, stContext.mConfigPara.mSubEncodeHeight);
    stContext.mpSubRecorder->setVideoSize(stContext.mConfigPara.mSubEncodeWidth, stContext.mConfigPara.mSubEncodeHeight);
    stContext.mpSubRecorder->setVideoEncoder(stContext.mConfigPara.mEncodeType);
    stContext.mpSubRecorder->setVideoEncodingBitRate(stContext.mConfigPara.mSubEncodeBitrate);

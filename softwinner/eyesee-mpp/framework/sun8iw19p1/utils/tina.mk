# Makefile for eyesee-mpp/framework/utils
CUR_PATH := .
PACKAGE_TOP := ..
...
LOCAL_TARGET_DYNAMIC := libcustomaw_media_utils
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libcustomaw_media_utils
endif
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-framework-utils done
	@echo ===================================
